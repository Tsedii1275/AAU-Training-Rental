      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <div className="flex items-center gap-3 p-4 rounded-lg bg-card border border-border">
          ...
          <div>
            ...
            <p className="text-sm font-medium">Defined roles</p>
          </div>
        </div>
      </div>
        ...
        <div className="flex gap-2">
          <Select>
            ...
            <SelectContent>
              ...
              <SelectItem value="ict">ICT Administrator</SelectItem>
              <SelectItem value="campus">Campus Administrator</SelectItem>
              <SelectItem value="training">Training Coordinator</SelectItem>
              <SelectItem value="rental">Rental Officer</SelectItem>
